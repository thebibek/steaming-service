         ...
         <b-col sm="12" class="overflow-hidden">
            <div class="iq-main-header d-flex align-items-center justify-content-between">
               <h4 class="main-title" v-b-tooltip.hover title="View All"> 
                  <nuxt-link to="/frontend/category-page" class="text-white">Upcoming Movies</nuxt-link>
               </h4>
            ...
            <div class="upcoming-contens">
               <VueSlickCarousel class="favorites-slider list-inline row p-0 mb-0" ref="dSlick" v-bind="upCommingSliderOption">
