...
&lt;/b-modal&gt;
            ...
            <b-button v-b-modal.modal-4 variant="primary" class="mr-1">
              Large modal
            </b-button>
            <b-button v-b-modal.modal-5 variant="primary" class="mr-1">
              Small modal
            </b-button>
            <b-modal id="modal-3" size="xl" title="Modal title" ok-title="Save Changes" cancel-title="Close">
              <p>Modal body text goes here.</p>
...
&lt;/b-modal&gt;
            ...
            <b-button v-b-modal.modal-7 variant="primary" class="mr-1">
              Launch demo modal
            </b-button>
            <b-button v-b-modal.modal-8 variant="primary" class="mr-1">
